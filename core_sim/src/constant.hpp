 ...
 public:
  ...
  class Config {
   public:
    ...
    static constexpr const char* payload_actors = "payload-actors";
    ...
    static constexpr const char* payload_actor = "payload_actor";
    ...
    static constexpr const char* env_actor_config = "env_actor_config";
    static constexpr const char* payload_actor_config = "payload-actor-config";
